...
- [`星みちTRPG 公開キャラクター・モンスターデータ`](公開設定/星みちTRPG_公開キャラクター・モンスターデータ.md)
  - シーリス・アルタイル、カイト、フィトリアット・マリアベル、カーヴェイン、マイン・A・レッドフォックス、紅焔、通常ゴブリンの公開データ
  - マインのキャラクターシート数値は現在未登録です
